...
def main():
    ...
    if choice == '1':
        try:
            listshell = input("[+] Enter Shell list: ")
            try:
        ...
        liists = input('Enter Your Shells :')
        ...
        liists = input('Enter Your Logins :')
        with open(liists) as f:
            for url in f:
                massupwp(url)
    elif choice == '14':
        url = input('Enter Your Shell :')
        ...
        ch = input('1-HackTarget Or 2-View :')
        if ch == '1':
            liists = input('Ips :')
            with open(liists) as f:
                for ip in f:
